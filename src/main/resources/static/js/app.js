...
/***/ function(module, exports, __webpack_require__) {
	...
	var Fox = function (_React$Component) {
	    ...
	    function Fox() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Fox).apply(this, arguments));
	    }
	...
	var Box = function (_React$Component2) {
	    ...
	    _createClass(Box, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: 'box box-' + this.props.type },
	                this.props.children
	            );
	        }
	    }]);
	...
	window.renderOnServer = function (name) {
	    return _server2.default.renderToString(_react2.default.createElement(
	        Box,
	        { type: "open" },
	        _react2.default.createElement(Fox, { name: name })
	    ));
	};
